...
if ([Console]::WindowWidth -lt $requiredWidth -or [Console]::WindowHeight -lt $requiredHeight) {
    [Console]::Clear()
    
    $currentWidth  = [Console]::WindowWidth
    $currentHeight = [Console]::WindowHeight
    $msg1 = "Console window must be at least ${requiredWidth}x${requiredHeight}."
    $msg2 = "Current size is ${currentWidth}x${currentHeight}. Resize and restart."

    $x1 = [math]::Floor(($currentWidth - $msg1.Length) / 2)
    $x2 = [math]::Floor(($currentWidth - $msg2.Length) / 2)
    ...
    [Console]::SetCursorPosition(0, $currentHeight - 1)
    exit
}
